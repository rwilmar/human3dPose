...
class Network:
    ...
    def load_model(self, model, device="CPU", cpu_extension=None):
        ...
        print ("input shape: ", network.inputs[self.input_blob].shape)
    ...
    def sync_inference2(self, image):
        '''
        Makes a synchronous inference request, given an input image.
        '''
        dict1={
            "data": image,
            "im_info": [544,992,2.1,1.7,2.1,1.7]
        }
        self.exec_network.infer({self.input_blob: dict1})
        return
